...
export default function LandingPage() {
  ...
  const steps = [
    ...
    { num: "02", title: "ارفع سيرتك الذاتية", desc: "ارفع ملف CV وحدد مجالات الوظائف ومنصات التقديم كجدارات وLinkedIn والمناطق التي تفضّلها" },
  ...
  const faqs = [
    ...
    { q: "هل يقدّم Jobbots على جدارات وLinkedIn؟", a: "نعم، Jobbots مصمّم للتقديم التلقائي على منصات التوظيف الرائدة في السعودية بما فيها جدارات وLinkedIn وغيرها، بشكل مستمر ودون أي تدخل منك." },
  ];
    ...
    <div style={s.page} dir="rtl">
      ...
      <section style={s.hero}>
        ...
        <p style={s.heroSub} className="hero-sub">
          Jobbots يقدّم عنك على المئات من الوظائف يومياً في جدارات وLinkedIn وغيرها بالذكاء الاصطناعي.{" "}
      ...
      <section style={s.companiesSection}>
        <div style={s.sectionInner}>
          <div style={{ textAlign: "center", marginBottom: 44 }}>
            ...
            <p style={s.sectionDesc}>
              يقدّم Jobbots عنك على كبرى الشركات والجهات في المملكة عبر منصات التوظيف المختلفة كجدارات وLinkedIn بشكل مستمر
            </p>
          </div>
