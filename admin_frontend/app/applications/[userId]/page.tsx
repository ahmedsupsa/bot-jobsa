  ...
  return (
    <Shell>
      <div className="p-4 md:p-6 space-y-5 max-w-5xl mx-auto" dir="rtl">
        {/* Back */}
        <Link href="/applications" className="inline-flex items-center gap-1.5 text-sm text-gray-500 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition">
