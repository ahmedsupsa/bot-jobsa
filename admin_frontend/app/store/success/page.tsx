...
function SuccessContent() {
  ...
  useEffect(() => {
    ...
    fetch("/api/store/verify", {
      ...
      body: JSON.stringify({ order_id, tamara_order_id, paymentStatus, payment_id, invoice_id, status }),
    })
      .then(r => r.json())
      .then(j => {
        if (j.ok) {
  ...
  }, [order_id, tamara_order_id, paymentStatus, payment_id, invoice_id, status]);
