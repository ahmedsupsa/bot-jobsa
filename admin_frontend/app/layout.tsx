...
export const metadata: Metadata = {
  ...
  keywords: "تقديم تلقائي على الوظائف, بوت وظائف, ذكاء اصطناعي, jobbots, وظائف السعودية, تقديم على جدارات تلقائي, بوت تقديم وظائف السعودية, تقديم على LinkedIn تلقائي, أداة تقديم وظائف, بحث عن وظيفة تلقائي, وظائف 2025, ذكاء اصطناعي وظائف, AI وظائف",
  openGraph: {
