        ...
        >
          ...
          <div>
            ...
            <input
              type="email"
              dir="ltr"
              className="w-full rounded-xl border border-line bg-[var(--input-bg)] px-3 py-2.5 text-sm text-ink placeholder:text-muted focus:outline-none focus:border-line2 text-right"
          ...
          <div>
            ...
            <textarea
              rows={10}
              className="w-full rounded-xl border border-line bg-[var(--input-bg)] px-3 py-2.5 text-sm text-ink placeholder:text-muted focus:outline-none focus:border-line2 leading-relaxed resize-y"
          ...
          <div className="flex justify-end pt-1">
            <button
              onClick={send}
              disabled={!canSend}
              className="flex items-center gap-2 rounded-xl bg-accent text-accent-fg px-5 py-2.5 text-sm font-bold hover:bg-panel2 disabled:opacity-40 disabled:cursor-not-allowed transition-all"
            >
              {sending
