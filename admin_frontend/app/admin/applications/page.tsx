                  ...
                  {filtered.map(app => (
                    <tr key={app.id} className="hover:bg-gray-50 dark:hover:bg-gray-750 transition">
                      <td className="py-3 px-4">
                        <Link href={`/admin/applications/${app.user_id}`} className="flex items-center gap-2 group">
                      ...
                      <td className="py-3 px-4">
                        <Link href={`/admin/applications/${app.user_id}`} className="text-indigo-500 hover:text-indigo-700 dark:hover:text-indigo-300 transition">
